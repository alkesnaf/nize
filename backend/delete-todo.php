<?php
	...
	function deleteTodo($hashedAuthToken, $todo_id) {
		...
		if ($result->num_rows < 1) {
			return ["message" => "You are not deleting your own todo"];
		}
		...
		return $success ? "Todo deleted successfully" : "Error deleting todo";
	}
	...
	$response = deleteTodo($hat, $todo_id);
